...
public class GreetingServiceConfig {
    ...
    @Profile("EN")
    @Bean
    I18mEnglishGreetingService i18nService(EnglishGreetingRepository englishGreetingRepository){
        return new I18mEnglishGreetingService(englishGreetingRepository);
    }
